      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-baseline justify-between gap-6 mb-16">
          <div>
            ...
            <p className="mt-3 flex items-center gap-2 font-mono text-sm text-neutral-500 tracking-wide whitespace-nowrap">
              <span className="text-red-600 mt-px shrink-0">—</span>
              SI 프로젝트의 특성상 내부 시스템의 경우 화면을 오픈할 수 없어 <span className="text-yellow-500">공식 홈페이지</span>로 대체합니다.
            </p>
          </div>
              ...
              >
                ...
                <div className="relative w-full aspect-video md:aspect-[16/10] overflow-hidden bg-neutral-900">
                  ...
                  <motion.img
                    ...
                    className="w-full h-full object-cover object-top grayscale brightness-50 group-hover:grayscale-0 group-hover:brightness-90 group-hover:scale-105 transition-all duration-700"
                  />
              ...
              >
                ...
                <div className="p-5 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                  ...
                  <div className="space-y-5 bg-neutral-900/40 p-5 border border-neutral-900 self-start">
                    ...
                    {selectedProject.category.toUpperCase().includes("SI PROJECT") && (
                      <p className="flex items-start gap-1.5 font-mono text-[10px] text-neutral-400 leading-relaxed">
